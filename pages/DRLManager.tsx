...
const CRITERIA = [
    ...
    { id: 'I.3', content: '3. Tham gia Hội thảo / Tọa đàm (3đ/lần)', max: 3, parent: 'I' },
    ...
    { id: 'I.12', content: '12. Các hoạt động học thuật khác', max: 3, parent: 'I' },
    ...
    { id: 'III.1', content: '1. Hoạt động bắt buộc do Khoa/Trường tổ chức (3đ/lần)', max: 3, parent: 'III' },
    { id: 'III.2', content: '2. Đại hội Chi đoàn/Chi hội, sinh hoạt Chi đoàn (3đ/lần)', max: 3, parent: 'III' },
    { id: 'III.3', content: '3. Báo cáo chuyên đề chính trị trực tiếp/trực tuyến', max: 4, parent: 'III' },
    ...
    { id: 'III.8', content: '8. Hoạt động điều động của Đoàn/Hội (2-4đ)', max: 4, parent: 'III' },
    ...
    { id: 'III.11', content: '11. Hoạt động đền ơn đáp nghĩa, thắp nến tri ân (3đ/lần)', max: 3, parent: 'III' },
    { id: 'III.12', content: '12. Lao động tình nguyện tại Trường (3đ/lần)', max: 3, parent: 'III' },
    { id: 'III.13', content: '13. Khen thưởng trong phong trào (5-7đ)', max: 7, parent: 'III' },
    { id: 'III.14', content: '14. Tập thể được khen thưởng (1đ/lần)', max: 1, parent: 'III' },
    { id: 'III.15', content: '15. Các hoạt động khác (1-3đ)', max: 3, parent: 'III' },
    ...
    { id: 'IV.11', content: '11. Phiên giao dịch việc làm (1-3đ)', max: 3, parent: 'IV' },
    ...
    { id: 'IV.18', content: '18. Hoạt động PTBV, Trách nhiệm xã hội (1-3đ)', max: 3, parent: 'IV' },
    ...
    { id: 'V.3', content: '3. Đạt giải về học tập, NCKH (3-7đ)', max: 7, parent: 'V' },
...
const DRLManager: React.FC = () => {
    ...
    const getScoreStatus = (studentId: string) => {
        ...
        if ((s.status as string) === 'rejected') return { label: 'Không duyệt', color: 'text-red-700 bg-red-100 border-red-200' };
